...
import { InfiniteSliderHoverSpeed } from "./PopularSkills";
...
export const HeroSection = () => {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center text-center py-18 px-4 overflow-hidden space-y-8">
      {/* Background Glow */}
